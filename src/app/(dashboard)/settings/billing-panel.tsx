...
const paidPlans: Array<Plan & { id: BillingPlan }> = [
  { id: "creator", title: "Creator", description: "For individual creators building a consistent publishing habit.", currency: "$", monthlyPrice: "29", yearlyPrice: "348", buttonText: "Choose Creator", features: [
    { name: "10 theme pages", icon: "check" }, { name: "12 content slots per page", icon: "check" }, { name: "Video rendering", icon: "check" }, { name: "Scheduled automation", icon: "check" },
  ] },
  { id: "pro", title: "Pro", description: "For teams running a high-volume social content operation.", currency: "$", monthlyPrice: "79", yearlyPrice: "948", buttonText: "Choose Pro", highlight: true, features: [
    { name: "100 theme pages", icon: "check" }, { name: "24 content slots per page", icon: "check" }, { name: "Video rendering", icon: "check" }, { name: "Scheduled automation", icon: "check" },
  ] },
  { id: "agency", title: "Agency", description: "For agencies managing large, multi-brand publishing programs.", currency: "$", monthlyPrice: "199", yearlyPrice: "2388", buttonText: "Choose Agency", features: [
    { name: "500 theme pages", icon: "check" }, { name: "48 content slots per page", icon: "check" }, { name: "Video rendering", icon: "check" }, { name: "Scheduled automation", icon: "check" },
  ] },
];
    ...
    <Card>
      ...
      <CardContent className="space-y-5">
        <div className="rounded-lg border p-4 space-y-2">
            ...
            <p className="text-sm text-muted-foreground">1 theme page, 3 content slots, manual runs and review before publishing.</p>
        </div>
        <PricingTableOne
