...
4. **Length**: Do not exceed 3000 characters.
...
Use the `draft_post` tool to save your drafted post variants to the database. Make sure you set the `platform` option in the tool to `linkedin`.
